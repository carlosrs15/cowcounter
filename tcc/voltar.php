...
<br>
    ...
    ?> 
            <tr>
                ...
                <td><a href="acao.php?devolvido=<?php echo $id;?>"><button class="btn-flat"><img class="icon" src="img/vender/vender.jpg"></button></a></td>
...
<br><br>
    ...
    <?php
        $sh = "SELECT  vacinagado.codigo,vacina.nome, vacinagado.datavacina, vacinagado.boicodigo
